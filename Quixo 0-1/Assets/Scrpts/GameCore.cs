...
public class GameCore : MonoBehaviour
{
    ...
    private System.Collections.IEnumerator winAnimation()
    {
        ...
        if (winType == WinType.vertical)
        {
            ...
            swordInstance = Instantiate(swordPrefab, new Vector3(-2815, 135, 0), Quaternion.identity);
        ...
        if (winType == WinType.Leftdiagonal)
        {
            ...
            axeInstance = Instantiate(axePrefab, new Vector3(-2847, 140, 5), Quaternion.identity);
        ...
        if (winType == WinType.horizontal)
        {
            ...
            spearInstance = Instantiate(spearPrefab, new Vector3(-2851, 140, 18), Quaternion.identity);
            Vector3 scale = spearInstance.transform.localScale;
            scale.y = 100f;
            scale.x = 100f;
            scale.z = 100f;
            spearInstance.transform.localScale = scale;
            spearInstance.transform.Rotate(90f, 0, 0, Space.Self);
        }
        if (winType == WinType.Rightdiagonal)
        {
            SoundFXManage.Instance.PlaySoundFXClip(axeWin, transform, 1f);
            axeInstance = Instantiate(axePrefab, new Vector3(-2844, 140, -2), Quaternion.identity);
            Vector3 scale = axeInstance.transform.localScale;
            scale.y = 90;
            scale.x = 90;
            scale.z = 90;
