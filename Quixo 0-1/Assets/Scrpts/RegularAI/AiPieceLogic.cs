...
public class AiPieceLogic : MonoBehaviour
{
    public int row;
    public int col;
    public char player;
    public AiGameCore game;
    private AiButtonHandler aiButtonHandler;
    ...
    private static AiPieceLogic selectedPiece; // C: Track the currently selected piece
