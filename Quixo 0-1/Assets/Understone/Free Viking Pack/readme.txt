...
To use the Free Viking Pack, you can simply drag the model (in folder "Models") or the prefab (in folder "Prefabs") into the scene.


LICENSE

Thank you for downloading the Free Viking Pack! 
